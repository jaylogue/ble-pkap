...
public:
     ...
     * 
     * Applications may provide implementations of these methods, which
     * will be called when the corresponding event occurs.
     */
    struct Event final
    {
        static void OnAdvertisingStarted(void) __WEAK;
        static void OnAdvertisingStopped(void)  __WEAK;
        static void OnConnectionEstablished(uint16_t conHandle, const ble_gap_evt_connected_t * conEvent)  __WEAK;
        static void OnConnectionTerminated(uint16_t conHandle, const ble_gap_evt_disconnected_t * disconEvent)  __WEAK;
        static void OnPairingRequested(uint16_t conHandle, const ble_gap_evt_sec_params_request_t * secParamsReq, uint8_t & secStatus, ble_gap_sec_params_t * secParamsReply) __WEAK;
        static void OnPairingCompleted(uint16_t conHandle, const ble_gap_evt_auth_status_t * authStatus) __WEAK;
    };
